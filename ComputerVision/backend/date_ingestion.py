...
def insert_features(id, productname, filename, features, productUrl, about, category):
    """
    ...
    cursor.execute('''
    INSERT INTO features (id, productname, filename, features, productUrl, about, category) VALUES (?, ?, ?, ?, ?, ?, ?)
    ''', (id, productname, filename, features_blob, productUrl, about, category))
...
for img in os.listdir(folder_path):
    try:
        ...
        insert_features(db_id,  amazon_df["product_name"][int(img[6:-4])-1], img, img_features, amazon_df["product_link"][int(img[6:-4])-1], amazon_df["about_product"][int(img[6:-4])-1], amazon_df["category"][int(img[6:-4])-1])
        db_id += 1
    except:
